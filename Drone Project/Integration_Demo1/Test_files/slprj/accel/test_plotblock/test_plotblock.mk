...
MODEL              = test_plotblock
MODULES            = HostLib_Multimedia.c HostLib_Video.c HostLib_rtw.c rtGetInf.c rtGetNaN.c rt_nonfinite.c test_plotblock_acc_data.c 
MAKEFILE           = test_plotblock.mk
MATLAB_ROOT        = C:/Program Files/MATLAB/R2015a
ALT_MATLAB_ROOT    = C:/PROGRA~1/MATLAB/R2015a
MASTER_ANCHOR_DIR  = 
START_DIR          = E:/GitHub/MSD2015/Drone Project/Integration_Demo1/Test_files
...
MEX_OPT_FILE       = -f C:/PROGRA~1/MATLAB/R2015a/rtw/c/tools/LCC-WI~1.XML
OPTIMIZATION_FLAGS = -DNDEBUG
ADDITIONAL_LDFLAGS = 

#--------------------------- Model and reference models -----------------------
MODELLIB                  = test_plotblocklib.lib
MODELREF_LINK_LIBS        = 
MODELREF_INC_PATH         = 
...
ADD_INCLUDES = \
	...
	-I$(START_DIR)/slprj/accel/test_plotblock \
	-I$(START_DIR) \
...
%.obj : $(MATLAB_ROOT)/toolbox/vision/include/%.c
	$(CC) $(MEX_FLAGS) $(INCLUDES) -Fo$(@F) $<
