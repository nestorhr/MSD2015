...
static void initialize_c2_TrilaterateBlock(SFc2_TrilaterateBlockInstanceStruct
  *chartInstance);
static void initialize_params_c2_TrilaterateBlock
  (SFc2_TrilaterateBlockInstanceStruct *chartInstance);
static void enable_c2_TrilaterateBlock(SFc2_TrilaterateBlockInstanceStruct
  *chartInstance);
static void disable_c2_TrilaterateBlock(SFc2_TrilaterateBlockInstanceStruct
  *chartInstance);
static void c2_update_debugger_state_c2_TrilaterateBlock
  (SFc2_TrilaterateBlockInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c2_TrilaterateBlock
  (SFc2_TrilaterateBlockInstanceStruct *chartInstance);
static void set_sim_state_c2_TrilaterateBlock
  (SFc2_TrilaterateBlockInstanceStruct *chartInstance, const mxArray *c2_st);
static void finalize_c2_TrilaterateBlock(SFc2_TrilaterateBlockInstanceStruct
  *chartInstance);
static void sf_gateway_c2_TrilaterateBlock(SFc2_TrilaterateBlockInstanceStruct
  *chartInstance);
static void mdl_start_c2_TrilaterateBlock(SFc2_TrilaterateBlockInstanceStruct
  *chartInstance);
static void initSimStructsc2_TrilaterateBlock
  (SFc2_TrilaterateBlockInstanceStruct *chartInstance);
...
static const mxArray *c2_b_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static real_T c2_emlrt_marshallIn(SFc2_TrilaterateBlockInstanceStruct
  *chartInstance, const mxArray *c2_b_r4, const char_T *c2_identifier);
static real_T c2_b_emlrt_marshallIn(SFc2_TrilaterateBlockInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static const mxArray *c2_c_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static void c2_c_emlrt_marshallIn(SFc2_TrilaterateBlockInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId,
  char_T c2_y[2]);
...
static const mxArray *c2_e_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static void c2_d_emlrt_marshallIn(SFc2_TrilaterateBlockInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId,
  char_T c2_y[6]);
...
static boolean_T c2_e_emlrt_marshallIn(SFc2_TrilaterateBlockInstanceStruct
  *chartInstance, const mxArray *c2_isempty, const char_T *c2_identifier);
static boolean_T c2_f_emlrt_marshallIn(SFc2_TrilaterateBlockInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_g_emlrt_marshallIn(SFc2_TrilaterateBlockInstanceStruct
  *chartInstance, const mxArray *c2_GetMC, const char_T *c2_identifier, real_T
  c2_y[4]);
static void c2_h_emlrt_marshallIn(SFc2_TrilaterateBlockInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId,
  real_T c2_y[4]);
static const mxArray *c2_g_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static int32_T c2_i_emlrt_marshallIn(SFc2_TrilaterateBlockInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_e_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static const mxArray *c2_j_emlrt_marshallIn(SFc2_TrilaterateBlockInstanceStruct *
  chartInstance, const mxArray *c2_b_s, const char_T *c2_identifier);
static const mxArray *c2_k_emlrt_marshallIn(SFc2_TrilaterateBlockInstanceStruct *
  chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static uint8_T c2_l_emlrt_marshallIn(SFc2_TrilaterateBlockInstanceStruct
  *chartInstance, const mxArray *c2_b_is_active_c2_TrilaterateBlock, const
  char_T *c2_identifier);
static uint8_T c2_m_emlrt_marshallIn(SFc2_TrilaterateBlockInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void init_dsm_address_info(SFc2_TrilaterateBlockInstanceStruct
  *chartInstance);
static void init_simulink_io_address(SFc2_TrilaterateBlockInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c2_is_active_c2_TrilaterateBlock = 0U;
}
  ...
  (SFc2_TrilaterateBlockInstanceStruct *chartInstance)
{
  ...
  c2_e_hoistedGlobal = chartInstance->c2_is_active_c2_TrilaterateBlock;
  ...
  (SFc2_TrilaterateBlockInstanceStruct *chartInstance, const mxArray *c2_st)
{
  ...
  *chartInstance->c2_r4 = c2_emlrt_marshallIn(chartInstance, sf_mex_dup
  ...
  chartInstance->c2_is_active_c2_TrilaterateBlock = c2_l_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c2_u, 5)),
     "is_active_c2_TrilaterateBlock");
  sf_mex_destroy(&c2_u);
  c2_update_debugger_state_c2_TrilaterateBlock(chartInstance);
...
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData)
{
  ...
  const mxArray *c2_y = NULL;
  SFc2_TrilaterateBlockInstanceStruct *chartInstance;
  chartInstance = (SFc2_TrilaterateBlockInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c2_TrilaterateBlock_get_eml_resolved_functions_info(void)
{
  ...
  char_T *c2_identifier)
{
  ...
  c2_y = c2_m_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c2_b_is_active_c2_TrilaterateBlock), &c2_thisId);
  sf_mex_destroy(&c2_b_is_active_c2_TrilaterateBlock);
  return c2_y;
}
...
void sf_c2_TrilaterateBlock_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c2_TrilaterateBlock_get_post_codegen_info(void);
mxArray *sf_c2_TrilaterateBlock_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c2_TrilaterateBlock_get_post_codegen_info();
...
mxArray *sf_c2_TrilaterateBlock_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c2_TrilaterateBlock_jit_fallback_info(void)
{
...
mxArray *sf_c2_TrilaterateBlock_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c2_TrilaterateBlock(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x6'type','srcId','name','auxInfo'{{M[1],M[5],T\"r1\",},{M[1],M[6],T\"r2\",},{M[1],M[7],T\"r3\",},{M[1],M[8],T\"r4\",},{M[4],M[0],T\"s\",S'l','i','p'{{M1x2[398 399],M[0],}}},{M[8],M[0],T\"is_active_c2_TrilaterateBlock\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 6, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c2_TrilaterateBlock_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc2_TrilaterateBlockInstanceStruct *)
...
static void sf_opaque_initialize_c2_TrilaterateBlock(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc2_TrilaterateBlockInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c2_TrilaterateBlock((SFc2_TrilaterateBlockInstanceStruct*)
    chartInstanceVar);
  initialize_c2_TrilaterateBlock((SFc2_TrilaterateBlockInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c2_TrilaterateBlock(void *chartInstanceVar)
{
  enable_c2_TrilaterateBlock((SFc2_TrilaterateBlockInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c2_TrilaterateBlock(void *chartInstanceVar)
{
  disable_c2_TrilaterateBlock((SFc2_TrilaterateBlockInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c2_TrilaterateBlock(void *chartInstanceVar)
{
  sf_gateway_c2_TrilaterateBlock((SFc2_TrilaterateBlockInstanceStruct*)
    chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c2_TrilaterateBlock(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c2_TrilaterateBlock((SFc2_TrilaterateBlockInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c2_TrilaterateBlock(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c2_TrilaterateBlock((SFc2_TrilaterateBlockInstanceStruct*)
    chartInfo->chartInstance, st);
}

static void sf_opaque_terminate_c2_TrilaterateBlock(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc2_TrilaterateBlockInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c2_TrilaterateBlock((SFc2_TrilaterateBlockInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc2_TrilaterateBlock((SFc2_TrilaterateBlockInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_TrilaterateBlock(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c2_TrilaterateBlock(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c2_TrilaterateBlock(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c2_TrilaterateBlock(SimStruct *S)
{
  SFc2_TrilaterateBlockInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc2_TrilaterateBlockInstanceStruct *)utMalloc(sizeof
    (SFc2_TrilaterateBlockInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc2_TrilaterateBlockInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c2_TrilaterateBlock;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c2_TrilaterateBlock;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c2_TrilaterateBlock;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c2_TrilaterateBlock;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c2_TrilaterateBlock;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c2_TrilaterateBlock;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c2_TrilaterateBlock;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c2_TrilaterateBlock;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c2_TrilaterateBlock;
  chartInstance->chartInfo.mdlStart = mdlStart_c2_TrilaterateBlock;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c2_TrilaterateBlock;
...
void c2_TrilaterateBlock_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_TrilaterateBlock(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_TrilaterateBlock(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_TrilaterateBlock(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_TrilaterateBlock_method_dispatcher.\n"
