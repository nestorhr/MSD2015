...
static void initialize_c1_Demo1(SFc1_Demo1InstanceStruct *chartInstance);
static void initialize_params_c1_Demo1(SFc1_Demo1InstanceStruct *chartInstance);
static void enable_c1_Demo1(SFc1_Demo1InstanceStruct *chartInstance);
static void disable_c1_Demo1(SFc1_Demo1InstanceStruct *chartInstance);
static void c1_update_debugger_state_c1_Demo1(SFc1_Demo1InstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c1_Demo1(SFc1_Demo1InstanceStruct
  *chartInstance);
static void set_sim_state_c1_Demo1(SFc1_Demo1InstanceStruct *chartInstance,
  const mxArray *c1_st);
static void finalize_c1_Demo1(SFc1_Demo1InstanceStruct *chartInstance);
static void sf_gateway_c1_Demo1(SFc1_Demo1InstanceStruct *chartInstance);
static void mdl_start_c1_Demo1(SFc1_Demo1InstanceStruct *chartInstance);
static void c1_chartstep_c1_Demo1(SFc1_Demo1InstanceStruct *chartInstance);
static void initSimStructsc1_Demo1(SFc1_Demo1InstanceStruct *chartInstance);
...
static const mxArray *c1_c_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static real_T c1_emlrt_marshallIn(SFc1_Demo1InstanceStruct *chartInstance, const
...
static void c1_b_emlrt_marshallIn(SFc1_Demo1InstanceStruct *chartInstance, const
  mxArray *c1_Trilateration, const char_T *c1_identifier, real_T c1_y[4]);
static void c1_c_emlrt_marshallIn(SFc1_Demo1InstanceStruct *chartInstance, const
  mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId, real_T c1_y[4]);
static const mxArray *c1_d_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static int32_T c1_d_emlrt_marshallIn(SFc1_Demo1InstanceStruct *chartInstance,
  const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static uint8_T c1_e_emlrt_marshallIn(SFc1_Demo1InstanceStruct *chartInstance,
  const mxArray *c1_b_is_active_c1_Demo1, const char_T *c1_identifier);
static uint8_T c1_f_emlrt_marshallIn(SFc1_Demo1InstanceStruct *chartInstance,
  const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void init_dsm_address_info(SFc1_Demo1InstanceStruct *chartInstance);
static void init_simulink_io_address(SFc1_Demo1InstanceStruct *chartInstance);
...
static void initialize_c1_Demo1(SFc1_Demo1InstanceStruct *chartInstance)
{
  ...
  chartInstance->c1_is_active_c1_Demo1 = 0U;
}
  ...
  *chartInstance)
{
  ...
  c1_hoistedGlobal = chartInstance->c1_is_active_c1_Demo1;
  ...
  const mxArray *c1_st)
{
  ...
  chartInstance->c1_is_active_c1_Demo1 = c1_e_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c1_u, 1)), "is_active_c1_Demo1");
  sf_mex_destroy(&c1_u);
  c1_update_debugger_state_c1_Demo1(chartInstance);
...
static void sf_gateway_c1_Demo1(SFc1_Demo1InstanceStruct *chartInstance)
{
  ...
  chartInstance->c1_sfEvent = CALL_EVENT;
  c1_chartstep_c1_Demo1(chartInstance);
...
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData)
{
  ...
  real_T c1_u[4];
  const mxArray *c1_y = NULL;
  SFc1_Demo1InstanceStruct *chartInstance;
  chartInstance = (SFc1_Demo1InstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c1_Demo1_get_eml_resolved_functions_info(void)
{
  ...
  const mxArray *c1_b_is_active_c1_Demo1, const char_T *c1_identifier)
{
  ...
  c1_thisId.fIdentifier = c1_identifier;
  c1_thisId.fParent = NULL;
  c1_y = c1_f_emlrt_marshallIn(chartInstance, sf_mex_dup(c1_b_is_active_c1_Demo1),
    &c1_thisId);
  sf_mex_destroy(&c1_b_is_active_c1_Demo1);
  return c1_y;
}
...
void sf_c1_Demo1_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c1_Demo1_get_post_codegen_info(void);
mxArray *sf_c1_Demo1_get_autoinheritance_info(void)
{
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c1_Demo1_get_post_codegen_info();
...
mxArray *sf_c1_Demo1_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c1_Demo1_jit_fallback_info(void)
{
...
mxArray *sf_c1_Demo1_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c1_Demo1(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[9],T\"P\",},{M[8],M[0],T\"is_active_c1_Demo1\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c1_Demo1_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc1_Demo1InstanceStruct *) chartInfo->chartInstance;
...
static void sf_opaque_initialize_c1_Demo1(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc1_Demo1InstanceStruct*) chartInstanceVar)->S,0);
  initialize_params_c1_Demo1((SFc1_Demo1InstanceStruct*) chartInstanceVar);
  initialize_c1_Demo1((SFc1_Demo1InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c1_Demo1(void *chartInstanceVar)
{
  enable_c1_Demo1((SFc1_Demo1InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c1_Demo1(void *chartInstanceVar)
{
  disable_c1_Demo1((SFc1_Demo1InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c1_Demo1(void *chartInstanceVar)
{
  sf_gateway_c1_Demo1((SFc1_Demo1InstanceStruct*) chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c1_Demo1(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c1_Demo1((SFc1_Demo1InstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c1_Demo1(SimStruct* S, const mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c1_Demo1((SFc1_Demo1InstanceStruct*)chartInfo->chartInstance, st);
}

static void sf_opaque_terminate_c1_Demo1(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc1_Demo1InstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c1_Demo1((SFc1_Demo1InstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc1_Demo1((SFc1_Demo1InstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c1_Demo1(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
    initialize_params_c1_Demo1((SFc1_Demo1InstanceStruct*)
      (chartInfo->chartInstance));
  }
}

static void mdlSetWorkWidths_c1_Demo1(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c1_Demo1(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c1_Demo1(SimStruct *S)
{
  SFc1_Demo1InstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc1_Demo1InstanceStruct *)utMalloc(sizeof
    (SFc1_Demo1InstanceStruct));
  memset(chartInstance, 0, sizeof(SFc1_Demo1InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c1_Demo1;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c1_Demo1;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c1_Demo1;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c1_Demo1;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c1_Demo1;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c1_Demo1;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c1_Demo1;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c1_Demo1;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c1_Demo1;
  chartInstance->chartInfo.mdlStart = mdlStart_c1_Demo1;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c1_Demo1;
...
void c1_Demo1_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   ...
   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c1_Demo1(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c1_Demo1(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c1_Demo1_method_dispatcher.\n"
